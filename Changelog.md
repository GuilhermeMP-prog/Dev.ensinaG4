...
[Bloco 4 — Coleta preliminar das empresas do ecossistema de IA (versão 1)]
...
[Guilherme]:
Baixei algumas empresas de IA usando a função criada;
Alinhei datas de cada ativo com o S&P500;
Calculei retornos acumulados para cada ação;
Montei subplots comparativos (empresa vs benchmark);
Produzi tabela resumo com retornos e datas iniciais/finais de cada série.
